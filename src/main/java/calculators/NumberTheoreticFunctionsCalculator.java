...
public class NumberTheoreticFunctionsCalculator {
    ...
    /**
     * There are the only nine negative numbers <i>d</i> such that the ring of
     * algebraic integers of <b>Q</b>(&radic;<i>d</i>) is a unique factorization
     * domain (though not necessarily Euclidean). These numbers are, in
     * descending order: -1, -2, -3, -7, -11, -19, -43, -67, -163 (in this
     * constant array, they are in the reverse order). These correspond to
