...
public class NotDivisibleException extends Exception {
     ...
     * algebraics.AlgebraicDegreeOverflowException} should be thrown instead.
     * And if there is an attempt to divide by 0, the appropriate exception to
     * throw would perhaps be IllegalArgumentException.
