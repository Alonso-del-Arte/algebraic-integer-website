...
public class NonUniqueFactorizationDomainException extends Exception {
     ...
     * calculators.NumberTheoreticFunctionsCalculator#HEEGNER_NUMBERS}. There
     * are many more real quadratic integer rings that are UFDs, but that's outside the scope
